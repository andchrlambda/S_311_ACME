...
Answer: Code review should ensure that code is formatted and commented so that
the author and others can easily understand the code's purpose and strategy.
PEP8 is the industry standard baseline for formatting and commenting in Python.
When I review another's code I pay attention to the quality of explanations
and PEP8 styling. I appreciate when others let me know if my comments need 
more elaboration.
...
Answer: Containers such as Dockerfiles. A dockerfile is  used to create
an image where you can deploy a container. Dockerfiles enable reproducible builds 
across operating systems. Dockerfiles specify a base (such as Debian) and all 
dependencies. This is ideal for project teams that are working
